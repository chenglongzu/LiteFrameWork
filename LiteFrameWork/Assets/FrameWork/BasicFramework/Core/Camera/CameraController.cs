...
namespace LiteFramework
{
    public class CameraController : SingletonMono<CameraController>
    {
        ...
        void Start()
        {
            ...
            EventManager.GetInstance().AddEvent(EventIdDefine.LightShakeCamera, LightShakeCamera);
            EventManager.GetInstance().AddEvent(EventIdDefine.NormalShakeCamera, NormalShakeCamera);
            EventManager.GetInstance().AddEvent(EventIdDefine.HardShakeCamera, HardShakeCamera);
        }
